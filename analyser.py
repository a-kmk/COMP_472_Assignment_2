...
class Analyser:
    ...
    def parse_reviews(self):
        for review in self.reviews:
            ...
            content_no_punc = review.content.translate(str.maketrans('', '', string.punctuation))
            title_no_punc = review.content.translate(str.maketrans('', '', string.punctuation))
    ...
    def compute_reviews_statistics(self):
    ...
    def compute_words_statistics(self):
        for word_record in self.vocabulary.items():
            self.positive_words += word_record.pos_freq
            self.negative_words += word_record.neg_freq
            self.total_words += word_record.pos_freq + word_record.neg_freq
